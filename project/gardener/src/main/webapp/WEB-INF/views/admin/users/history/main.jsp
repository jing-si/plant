...
<script type="text/javascript">
	$(function() {
		$("div[data-url='bookmark']").trigger("click")
				...
				<header class="header border-bot">
					<div class="row mx-0 px-0">
						...
						<div class="col-10  ms-3 pt-2 nav">
							<div class="option col-2 pt-2 pb-3" data-url="bookmark">
								<h5 class="center"><i class="bi"></i> 즐겨찾기 관리</h5>
							</div>
							<div class="option col-2 pt-2 pb-3" data-url="history">
								<h5 class="center"><i class="bi"></i> 인증기록 관리</h5>
							</div>
