...
//	  
	  //숲꾸미기
		 ...
		 * ArrayList<Location>(); Location l1 = new Location(); l1.setLocationId(1);
		 * l1.setLocationOrder(999); l1.setLocationSize(1); l1.setLocationX(10);
		 * l1.setLocationY(10); l1.setPlantId(1);
		 * l1.setPlantImage("/resources/images/tree8.png");
		 * 
		 * list.add(l1);
		 * 
		 * Location l2 = new Location(); l2.setLocationId(2); l2.setLocationOrder(101);
		 * l2.setLocationSize(1.2f); l2.setLocationX(50); l2.setLocationY(50);
		 * l2.setPlantId(2); l2.setPlantImage("/resources/images/tree2.png");
		 * 
		 * list.add(l2);
		 * 
		 * Location l3 = new Location(); l3.setLocationId(3); l3.setLocationOrder(102);
		 * l3.setLocationSize(1.2f); l3.setLocationX(50); l3.setLocationY(50);
		 * l3.setPlantId(3); l3.setPlantImage("/resources/images/tree2.png");
		 * 
		 * list.add(l3);
		 * 
		 * Location l4 = new Location(); l4.setLocationId(4); l4.setLocationOrder(103);
		 * l4.setLocationSize(1.2f); l4.setLocationX(50); l4.setLocationY(50);
		 * l4.setPlantId(4); l4.setPlantImage("/resources/images/tree2.png");
		 * 
		 * list.add(l4);
		 * 
		 * Location l5 = new Location(); l5.setLocationId(1); l5.setLocationOrder(104);
		 * l5.setLocationSize(1.2f); l5.setLocationX(50); l5.setLocationY(50);
		 * l5.setPlantId(5); l5.setPlantImage("/resources/images/tree2.png");
		 * 
		 * list.add(l5);
		 * 
		 * Location l6 = new Location(); l6.setLocationId(1); l6.setLocationOrder(105);
		 * l6.setLocationSize(1.2f); l6.setLocationX(50); l6.setLocationY(50);
		 * l6.setPlantId(6); l6.setPlantImage("/resources/images/tree2.png");
		 * 
		 * list.add(l6);
		 * 
		 * Location l7 = new Location(); l7.setLocationId(1); l7.setLocationOrder(106);
		 * l7.setLocationSize(1.2f); l7.setLocationX(50); l7.setLocationY(50);
		 * l7.setPlantId(7); l7.setPlantImage("/resources/images/tree2.png");
		 * 
		 * list.add(l7);
		 * 
		 * Location l8 = new Location(); l8.setLocationId(8); l8.setLocationOrder(101);
		 * l8.setLocationSize(1.2f); l8.setLocationX(50); l8.setLocationY(50);
		 * l8.setPlantId(8); l8.setPlantImage("/resources/images/tree3.png");
		 * 
		 * list.add(l8);
		 * 
		 * Location l9 = new Location(); l9.setLocationId(9); l9.setLocationOrder(102);
		 * l9.setLocationSize(1.2f); l9.setLocationX(50); l9.setLocationY(50);
		 * l9.setPlantId(9); l9.setPlantImage("/resources/images/tree3.png");
		 * 
		 * list.add(l9);
		 * 
		 * Location l10 = new Location(); l10.setLocationId(10);
		 * l10.setLocationOrder(103); l10.setLocationSize(1.2f); l10.setLocationX(50);
		 * l10.setLocationY(50); l10.setPlantId(10);
		 * l10.setPlantImage("/resources/images/tree3.png");
		 * 
		 * list.add(l10);
		 * 
		 * Location l11 = new Location(); l11.setLocationId(11);
		 * l11.setLocationOrder(104); l11.setLocationSize(1.2f); l11.setLocationX(50);
		 * l11.setLocationY(50); l11.setPlantId(11);
		 * l11.setPlantImage("/resources/images/tree3.png");
		 * 
		 * list.add(l11);
		 * 
		 * Location l12 = new Location(); l12.setLocationId(12);
		 * l12.setLocationOrder(105); l12.setLocationSize(1.2f); l12.setLocationX(50);
		 * l12.setLocationY(50); l12.setPlantId(12);
		 * l12.setPlantImage("/resources/images/tree3.png");
		 * 
		 * list.add(l12);
		 * 
		 * Location l13 = new Location(); l13.setLocationId(13);
		 * l13.setLocationOrder(106); l13.setLocationSize(1.2f); l13.setLocationX(50);
		 * l13.setLocationY(50); l13.setPlantId(13);
